...
sablono.util.ToString = (function (){var obj17033 = {};
return obj17033;
})();
...
return (function (){var or__4163__auto__ = (sablono.util.to_str[(function (){var G__17037 = x__4799__auto__;
return goog.typeOf(G__17037);
})()]);
if(or__4163__auto__){
return or__4163__auto__;
} else {
var or__4163__auto____$1 = (sablono.util.to_str["_"]);
...
sablono.util.ToURI = (function (){var obj17039 = {};
return obj17039;
})();
...
var x__4799__auto__ = (((x == null))?null:x);
return (function (){var or__4163__auto__ = (sablono.util.to_uri[(function (){var G__17043 = x__4799__auto__;
return goog.typeOf(G__17043);
})()]);
if(or__4163__auto__){
return or__4163__auto__;
} else {
var or__4163__auto____$1 = (sablono.util.to_uri["_"]);
if(or__4163__auto____$1){
return or__4163__auto____$1;
} else {
...
while (G__17044__i < G__17044__a.length) {G__17044__a[G__17044__i] = arguments[G__17044__i + 0]; ++G__17044__i;}
  xs = new cljs.core.IndexedSeq(G__17044__a,0);
} 
return sablono$util$as_str__delegate.call(this,xs);};
sablono$util$as_str.cljs$lang$maxFixedArity = 0;
sablono$util$as_str.cljs$lang$applyTo = (function (arglist__17045){
var xs = cljs.core.seq(arglist__17045);
...
var vec__17047 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17047,(0),null);
var words = cljs.core.nthnext(vec__17047,(1));
...
var G__17049 = clojure.set.rename_keys(m,kmap);
var G__17049__$1 = ((cljs.core.map_QMARK_(cljs.core.constant$keyword$style.cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__17049,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$style], null),sablono$util$camel_case_keys):G__17049);
return G__17049__$1;
} else {
return m;
}
...
var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__17050_SHARP_){
if(cljs.core.list_QMARK_(p1__17050_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__17050_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_(p1__17050_SHARP_)){
...
while (G__17051__i < G__17051__a.length) {G__17051__a[G__17051__i] = arguments[G__17051__i + 0]; ++G__17051__i;}
  maps = new cljs.core.IndexedSeq(G__17051__a,0);
} 
return sablono$util$merge_with_class__delegate.call(this,maps);};
sablono$util$merge_with_class.cljs$lang$maxFixedArity = 0;
sablono$util$merge_with_class.cljs$lang$applyTo = (function (arglist__17052){
var maps = cljs.core.seq(arglist__17052);
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17056,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17056,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__17056,tag_name,names){
return (function (p1__17053_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__17053_SHARP_));
});})(matches,vec__17056,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__17056,tag_name,names){
return (function (p1__17054_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__17054_SHARP_));
});})(matches,vec__17056,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__17057){
var vec__17060 = p__17057;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17060,(0),null);
var content = cljs.core.nthnext(vec__17060,(1));
...
var vec__17061 = sablono.util.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17061,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17061,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17061,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__4163__auto__ = x__$1.hasDomain();
